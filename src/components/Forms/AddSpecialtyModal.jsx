...
function AddSpecialtyModal({ isOpen, onClose, onAdd }) {
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      setSaving(false)
      setError(addError.message || 'Could not add specialty. Please try again.')
    }
  }
  ...
  return (
    ...
    >
      ...
      >
        <h3 className="mb-4 text-lg font-semibold text-gray-900">Add New Specialty</h3>

        <label htmlFor="specialtyName" className="mb-1 block text-sm font-medium text-gray-700">
          Specialty Name
        </label>
        <input
          id="specialtyName"
